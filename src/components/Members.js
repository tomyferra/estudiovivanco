        ...
        <div class="container-fluid my-5 text-center">
          <div className="card card-container justify-content-center flex-row">
            ...
            <div class="col-lg-8 d-flex flex-column align-items-center justify-content-center">
              ...
              <p class="text-justify">El Sr. Jorge P. Vivanco inició su Carrera en el campo de los seguros en 1956 y fundó la firma que lleva su nombre en 1978.</p>
        ...
        <div class="container-fluid my-5 text-center">
          <div className="card card-container justify-content-center flex-row">
            <div class="col-lg-8 d-flex flex-column align-items-center justify-content-center">
              ...
              <p class="text-justify">El Sr. Esteban A. Vivanco ingresó a la firma en 1982 y se convirtió en socio en 1987. También participa regularmente de Seminarios y discusiones relacionadas con todos los aspectos de Seguros Marítimos, Derecho de Navegación, Reclamos de Casco y Maquinaria, Averia General, etc.</p>
              <p className="text-justify">Desde 2005, el Sr. Esteban A. Vivanco es el representante de Argentina en la <b>A.I.D.E. - “Association Internationale des Dispacheurs Europèens”</b> (La Asociación Internacional de Liquidadores de Averia Grusa) actualmente <b>AMD - “Association Mondiale de Dispacheurs”</b>. Participa activamente de las reuniones anuales y en los grupos de trabajo organizados para formular las actividades de las mismas, específicamente las relacionadas con Avería General, Seguros de Casco y Maquinaria.</p>
